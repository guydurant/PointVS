...
for c in casf_types_files:
	for m in models:
		os.system(f'python point_vs/inference.py ../{m} {c} /data/localhost/not-backed-up/durant/pdbbind_2020_general_parquets  --wandb_project PointBAP --wandb_run {m.split('/')[-1]}')
